    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="" action="/organizer/lomba/{{$lomba->id}}/download/penilaian_simpan" method="post">
                ...
                <table class="table">
                    <?php
                    $pesertas = \App\LombakuPeserta::where('kategori_id', $kategori->id)->orderByRaw('CAST(ratarata AS DECIMAL(5,2)) DESC,juara ASC')->get();
                    // echo $pesertas;
                    $isSong2 = false;
                    $isSong3 = false;
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <th scope="row"  name="nama[]">{{$peserta->nama}}</th>
                        <td>
