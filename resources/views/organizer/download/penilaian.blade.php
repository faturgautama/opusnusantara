...
<div class="container">
    <div class="row">
        <div class="col">
            <h3 class="h-block">Penilaian Juri</h3>
        </div>
    </div>
</div>
<br>
<div class="container">
    <div class="card">
        ...
        <form id="form" action="/organizer/lomba/{{$data['lomba']->id}}/download/penilaian/list" method="get">
            {{csrf_field()}}
            <?php
            ...
            <div class="w-block" align="right">
                <a href="/organizer/lomba/{{$data['lomba']->id}}/" class="h-block btn btn-primary waves-effect waves-light">Back</a>
