...
<div class="container">
  <div class="card">
    <h2 class="m-4">Lomba</h2>
    <div class="card-body">
      <form action="/organizer/lomba/{{$lomba->id}}" method="POST">
        {{csrf_field()}}
          <div class="form-group">
              <label for="name">Nama Kategori</label>
              <input name="name" type="text" class="form-control" id="name" placeholder="Masukkan Kategori Lomba" value="" required>
          </div>

          <div class="form-group">
            <div class="form-group row">
              <label for="range_04" class="col-sm-1 col-xs-12 control-label">
                <span class="display-block">Min Max</span>
              </label>
          ...
          <div class="form-group">
            ...
            <div class="radio form-check-inline">
              <input type="radio" id="song_type" value="Pilihan" name="song_type" >
              <label for="song_type"> Pilihan </label>
            </div>
            <div class="radio form-check-inline">
              <input type="radio" id="song_type2" value="Sendiri" name="song_type">
          ...
          <div class="form-group">
              ...
              <input name="song_set" type="text" class="form-control" id="song_set" placeholder="Jumlah Lagu" value="" required>
          </div>

          <div class="form-group">
              <label for="song_selection">Lagu</label>
              <input name="song_selection" type="text" class="form-control" id="song_selection" placeholder="Lagu" value="" required>
          </div>
