...
<div class="container">
    <div class="card">
        ...
        <form id="form" action="/organizer/lomba/{{$peserta->lombaku->id}}/peserta/{{$peserta->id}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            @method('PUT')
            ...
            <div class="form-group">
                <label for="no_undiap">No Undian</label>
                <input type="text" class="form-control" name="no_undian" id="no_undian" aria-describedby="emailHelp" value="{{$peserta->no_undian}}" placeholder="">
            </div>
            ...
            <div id="piece_template">
                ...
                @if($peserta->kategori->song_type=="pilihan")
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="song1" name="song1" required>
                            ...
                            @endif
                             @if($peserta->kategori->song9)
                            <option value="9">{{$peserta->kategori->song9}}</option>
                            @endif
                             @if($peserta->kategori->song10)
                            <option value="10">{{$peserta->kategori->song10}}</option>
                            @endif
                        </select>
                    </div>
                @endif
                @if($peserta->kategori->song_type=="bebas")
                    ...
                    @endfor
                @endif
                @if($peserta->kategori->song_type_final == 'bebas')
                    @if($peserta->kategori->song_set_final >= 1)
                    <div class="form-group">
                        <label for="song_final1">Piece Final 1</label>
                        <input type="text" class="form-control" name="song_final1" value="{{$peserta->song1_final}}" placeholder="" required>
                    </div>
                    @endif
                    @if($peserta->kategori->song_set_final >= 2)
                    <div class="form-group">
                        <label for="song_final2">Piece Final 2</label>
                        <input type="text" class="form-control" name="song_final2" value="{{$peserta->song2_final}}" placeholder="" required>
                    </div>
                    @endif
                    @if($peserta->kategori->song_set_final == 3)
                    <div class="form-group">
                        <label for="song_final3">Piece Final 3</label>
                        <input type="text" class="form-control" name="song_final3" value="{{$peserta->song3_final}}" placeholder="" required>
                    </div>
                    @endif
                @endif
            </div>
            ...
            <div class="w-block" align="right">
                <a href="/organizer/lomba/{{$peserta->lombaku->lomba_id}}/peserta/{{$peserta->id}}" class="h-block btn btn-primary waves-effect waves-light">Back</a>
