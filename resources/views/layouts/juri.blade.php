            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="/juri" class="logo"><i class="icon-magnet icon-c-logo"></i><span>Juri<i class="md md-album">
                        @if(\Auth::user()->email=='juri1@gmail.com')
                        1
                        @endif
                        @if(\Auth::user()->email=='juri2@gmail.com')
                    ...
                    <ul class="list-inline float-right mb-0">
                        ...
                        <li class="list-inline-item dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown " aria-labelledby="Preview">
                                ...
                                @if(\Auth::user()->email=='juri1@gmail.com')
                                <a href="/logout1" class="dropdown-item notify-item">
                                    <i class="zmdi zmdi-power"></i> <span>Logout</span>
                                </a>
                                @endif
                                @if(\Auth::user()->email=='juri2@gmail.com')
                                <a href="/logout2" class="dropdown-item notify-item">
                                    <i class="zmdi zmdi-power"></i> <span>Logout</span>
                                </a>
                                @endif
                                @if(\Auth::user()->email=='juri3@gmail.com')
                                <a href="/logout3" class="dropdown-item notify-item">
                                    <i class="zmdi zmdi-power"></i> <span>Logout</span>
                                </a>
                                @endif
