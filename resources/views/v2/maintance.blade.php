                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <div class="input-group-text">                          
                        <i class="text-secondary fa fa-commenting-o"></i>
                      </div>
                    </div>
                    <input type="text" class="form-control" placeholder=" Messege Leave">
