            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="stl_03">
                        ...
                        <img src="/image/ppt-makasar.jpg" alt="" class="stl_04">
                        @endif
                        @if($kategori->lomba_id == 14)
                        <img src="/image/ppt-srby.jpg" alt="" class="stl_04">
                        @endif
                        @if($kategori->lomba_id == 16)
                        <img src="/image/ppt-smg.jpg" alt="" class="stl_04">
                        @endif
                    </div>
                    <div class="col-md-12">
                        ...
                        <div style="margin-left: 22%">
                            <br>
                            <h3 class="text-center"><i>Kategori {{$lombanama}}</i></h3>
                            <br>
