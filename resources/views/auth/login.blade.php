...
<body>
    ...
    <div class="wrapper-page pt-4">
        <div class="card-box">
            <div class="panel-heading">
                <h4 class="text-center"> Sign In to <strong class="text-custom">OpusNusantara</strong></h4>
            </div>
            ...
            <div class="p-20">
                <form class="form-horizontal m-t-20" action="{{ route('login') }}" method="POST">
                    ...
                    <div class="form-group ">
                        <div class="col-12">
                        <input class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" type="text" required name="email" placeholder="E-Mail Address" value="{{ old('email') }}" required autofocus>                            
